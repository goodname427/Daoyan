...
describe('Feature PM recovery checkpoint', () => {
  ...
  it('persists a real resumable checkpoint before requesting a producer decision', async () => {
    ...
    await writeFile(resolve(temporary, 'package.json'), JSON.stringify({ type: 'module' }), 'utf8');
    ...
    const result = spawnSync(
      ...
      { cwd: temporary, encoding: 'utf8', timeout: 20_000 },
    );
