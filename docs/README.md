...
7. [`reference/扩展元法术.md`](./reference/扩展元法术.md)：元法术扩展作者的注册与定价约定。
8. [`architecture/overview.md`](./architecture/overview.md) 与 [`architecture/invariants.md`](./architecture/invariants.md)：模块边界和核心不变量。
9. [`workflow.md`](./workflow.md) 与 [`testing.md`](./testing.md)：开发和验证方式。
10. [`agent-workflow.md`](./agent-workflow.md)：制作人和常驻秘书的唯一协作入口。
...
| [`operations/`](./operations/feature-pm.md) | Feature PM 恢复、诊断和通讯部署    | 运维能力变化     |
